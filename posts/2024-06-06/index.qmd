...
Today we pushed our preprint to the [Ar$\chi$iv](https://arxiv.org/abs/2406.02895), so can show off our great new "Queue-Based Invasion Percolation" algorithm (QBIP) while we wait for the peer review process to run its course. 
